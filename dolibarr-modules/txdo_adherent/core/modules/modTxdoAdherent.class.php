 ...
 */
class modTxdoAdherent extends DolibarrModules
{
    /**
    ...
    public function __construct($db)
    {
        ...
        $this->description = "Module Txirrindola Adhérent";

        $this->descriptionlong = "Modification des fiches adhérents.";
